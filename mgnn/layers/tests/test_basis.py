...
class TestGaussianAndSphericalBesselFuction(unittest.TestCase):
    ...
    def test_spherical_harmonic_function(self):
        ...
        self.assertListEqual([abf.size(dim=0), abf.size(dim=1)], [10, 9])
