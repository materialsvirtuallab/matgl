...
immediately after the super()._\_init_\_() call:
...
This should be called after super in the \_\_init_\_ method, e.g., self.save_args(locals(), kwargs).
...
Bases: [`MatglLightningModuleMixin`](#matgl.utils.training.MatglLightningModuleMixin), `LightningModule`
