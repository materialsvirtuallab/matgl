...
* [matgl.ext package](matgl.ext.md)
  * [matgl.ext.ase module](matgl.ext.md#module-matgl.ext.ase)
    ...
    * [`OPTIMIZERS`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS)
      * [`OPTIMIZERS.bfgs`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.bfgs)
      * [`OPTIMIZERS.bfgslinesearch`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.bfgslinesearch)
      * [`OPTIMIZERS.fire`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.fire)
      * [`OPTIMIZERS.lbfgs`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.lbfgs)
      * [`OPTIMIZERS.lbfgslinesearch`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.lbfgslinesearch)
      * [`OPTIMIZERS.mdmin`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.mdmin)
      * [`OPTIMIZERS.scipyfminbfgs`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.scipyfminbfgs)
      * [`OPTIMIZERS.scipyfmincg`](matgl.ext.md#matgl.ext.ase.OPTIMIZERS.scipyfmincg)
...
* [matgl.layers package](matgl.layers.md)
  * [matgl.layers._activations module](matgl.layers.md#module-matgl.layers._activations)
    * [`ActivationFunction`](matgl.layers.md#matgl.layers._activations.ActivationFunction)
      * [`ActivationFunction.sigmoid`](matgl.layers.md#matgl.layers._activations.ActivationFunction.sigmoid)
      * [`ActivationFunction.softexp`](matgl.layers.md#matgl.layers._activations.ActivationFunction.softexp)
      * [`ActivationFunction.softplus`](matgl.layers.md#matgl.layers._activations.ActivationFunction.softplus)
      * [`ActivationFunction.softplus2`](matgl.layers.md#matgl.layers._activations.ActivationFunction.softplus2)
      * [`ActivationFunction.swish`](matgl.layers.md#matgl.layers._activations.ActivationFunction.swish)
      * [`ActivationFunction.tanh`](matgl.layers.md#matgl.layers._activations.ActivationFunction.tanh)
