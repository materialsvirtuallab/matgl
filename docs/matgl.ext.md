...
### *class* matgl.ext.ase.M3GNetCalculator(potential: [Potential](matgl.apps.md#matgl.apps.pes.Potential), state_attr: torch.Tensor | None = None, stress_weight: float = 1.0, \*\*kwargs)
...
* **Parameters:**
  ...
  * **\*\*kwargs** – Kwargs pass through to super()._\_init_\_().
...
### *class* matgl.ext.ase.Relaxer(potential: [Potential](matgl.apps.md#matgl.apps.pes.Potential) | None = None, state_attr: torch.Tensor | None = None, optimizer: Optimizer | str = 'FIRE', relax_cell: bool = True, stress_weight: float = 0.01)
