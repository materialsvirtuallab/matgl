"""Implementation of MatErials Graph Network (MEGNet) model for PyG.
...
class MEGNet(MatGLModel):
    ...
    def predict_structure(
        ...
        _, bond_dist = compute_pair_vector_and_distance_pyg(g)
        g.bond_dist = bond_dist
