...
class EdgeSet2Set(Module):
    ...
    def forward(self, g: Data, feat: torch.Tensor):
        ...
        with g.local_scope():
            ...
            for _ in range(self.n_iters):
                ...
                e = (feat * # TODO: use torch_geometric.utils.scatter_(g, q)).sum(dim=-1, keepdim=True)
                g.edata["e"] = e
                alpha = # TODO: use torch_geometric.utils.softmax(g, "e")
                g.edata["r"] = feat * alpha
                readout = # TODO: use torch_scatter.scatter(g, "r")
